...
namespace TestHestonCalibrator
{
    public class CompositeIntegrator
    {
        ...
        { 1.0/6.0,   4.0/6.0,   1.0/6.0,         0,        0},  // Simpson's 1/3 rule 
        { 1.0/8.0,   3.0/8.0,   3.0/8.0,   1.0/8.0,        0},  // Simpson's 3/8 rule
        {7.0/90.0, 32.0/90.0, 12.0/90.0, 32.0/90.0, 7.0/90.0} };// Boole's rule
        ...
        private void updateQuadraturePointsAndFvals(double a, double h, Func<double, double> f)
        {
            ...
            for (int i = 0; i <= newtonCotesOrder; i++)
            {
                ...
                //Console.WriteLine(quadraturePointsFVal[i]);
